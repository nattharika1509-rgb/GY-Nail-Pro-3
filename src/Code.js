...
function getAIAdvice(data) {
  ...
  try {
    ...
    let prompt = `คุณเป็นผู้เชี่ยวชาญด้านการทำเล็บมืออาชีพ (Nail Technician) ชื่อ "พี่ GY" จากร้าน GY-Nail\n\n`;
    prompt += `ให้คำแนะนำเกี่ยวกับการทำเล็บแบบมืออาชีพ เข้าใจง่าย เป็นกันเอง ใช้ภาษาที่เป็นมิตร\n\n`;
